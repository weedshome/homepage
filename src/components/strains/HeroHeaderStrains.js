...
import EmailBg from '../../assets/backgroundStrain.svg'


const HeroHeaderStrains = () => {
    useEffect(() => {
            ...
            <section data-aos="fade-up">
                <div className="home-width">
                    <div class="grid-container-business">
                        <div class="k-1">
                            <div class="k-title">
                                <h2 className="business-title">Browse Cannabis Strains</h2>
                            </div>
...
export default HeroHeaderStrains